...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('vodkamartiniqa_question', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=128))

    def backwards(self, orm):

        # Changing field 'Question.slug'
        db.alter_column('vodkamartiniqa_question', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
