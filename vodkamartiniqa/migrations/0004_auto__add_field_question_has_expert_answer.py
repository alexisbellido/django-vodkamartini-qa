...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.has_expert_answer'
        db.add_column('vodkamartiniqa_question', 'has_expert_answer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.has_expert_answer'
        db.delete_column('vodkamartiniqa_question', 'has_expert_answer')
